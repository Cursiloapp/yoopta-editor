const Resizer = ({ position }) => (
  <div
    ...
    className={`absolute flex items-center justify-center z-10 opacity-1 h-full w-[15px] cursor-col-resize transition-opacity duration-150 ease-in ${ position === 'left' ? 'left-0 top-0' : 'right-0 top-0'
    }`}
  >
