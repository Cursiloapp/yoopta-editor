...
const FileUploader = ({ accept = 'image/*', onClose, blockId, onSetLoading }: Props) => {
  ...
  return (
    <div className="yoo-image-user-select-none yoo-image-transition-bg yoo-image-duration-20 yoo-image-ease-in yoo-image-white-space-nowrap yoo-image-rounded-[4px] yoo-image-h-[32px] yoo-image-px-[12px] yoo-image-border yoo-image-border-solid yoo-image-border-[rgba(55,53,47,0.16)] yoo-image-w-full yoo-image-cursor-pointer yoo-image-bg-[#fe4a55] yoo-image-text-[#fff]">
      <label
