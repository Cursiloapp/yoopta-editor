...
const FileRender = ({ extendRender, ...props }: PluginElementRenderProps) => {
  ...
  return (
    ...
    >
      {blockSelected && (
        <div className="yoo-file-absolute yoo-file-pointer-events-none yoo-file-inset-0 yoo-file-bg-[rgba(254,75,85,0.14)] yoo-file-z-[81] yoo-file-rounded-[3px] yoo-file-opacity-100 yoo-file-transition-opacity yoo-file-duration-150 yoo-file-ease-in" />
      )}
